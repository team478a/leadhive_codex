...
メール・フォーム送信と追客の運用手順は [`docs/41_SMTP_SETTINGS_MANAGEMENT.md`](docs/41_SMTP_SETTINGS_MANAGEMENT.md) から [`docs/63_COLLECTION_PERFORMANCE_INSIGHTS.md`](docs/63_COLLECTION_PERFORMANCE_INSIGHTS.md) を参照してください。
