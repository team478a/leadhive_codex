...
メール・フォーム送信と追客の運用手順は [`docs/41_SMTP_SETTINGS_MANAGEMENT.md`](docs/41_SMTP_SETTINGS_MANAGEMENT.md) から [`docs/50_OUTREACH_TEMPLATES_AND_APPROVALS.md`](docs/50_OUTREACH_TEMPLATES_AND_APPROVALS.md) を参照してください。
