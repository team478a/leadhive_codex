...
メール・フォーム送信と追客の運用手順は [`docs/41_SMTP_SETTINGS_MANAGEMENT.md`](docs/41_SMTP_SETTINGS_MANAGEMENT.md) から [`docs/49_FOLLOWUP_TASKS.md`](docs/49_FOLLOWUP_TASKS.md) を参照してください。
