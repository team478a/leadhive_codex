...
メール・フォーム送信と追客の運用手順は [`docs/41_SMTP_SETTINGS_MANAGEMENT.md`](docs/41_SMTP_SETTINGS_MANAGEMENT.md) から [`docs/61_FOLLOWUP_DUE_TODAY_NOTIFICATIONS.md`](docs/61_FOLLOWUP_DUE_TODAY_NOTIFICATIONS.md) を参照してください。
