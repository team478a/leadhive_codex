...
メール・フォーム送信と追客の運用手順は [`docs/41_SMTP_SETTINGS_MANAGEMENT.md`](docs/41_SMTP_SETTINGS_MANAGEMENT.md) から [`docs/57_OUTREACH_DELIVERY_ELIGIBILITY.md`](docs/57_OUTREACH_DELIVERY_ELIGIBILITY.md) を参照してください。
