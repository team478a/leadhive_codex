...
メール・フォーム送信の運用手順は [`docs/41_SMTP_SETTINGS_MANAGEMENT.md`](docs/41_SMTP_SETTINGS_MANAGEMENT.md) から [`docs/48_CODEX_ASSISTED_FORM_RESULTS.md`](docs/48_CODEX_ASSISTED_FORM_RESULTS.md) を参照してください。
